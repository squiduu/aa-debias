...
import os
import re
from seat_utils import clear_console, get_seat_logger, load_encodings, load_json, save_encodings, set_seed
...
def run_seat(args: Namespace, logger: Logger):
    ...
    for model_name in available_models:
        ...
        for result in results:
            logger.info("\tTest {test}\tp-value: {p_value:.4f}\teffect-size: {effect_size:.2f}".format(**result))
