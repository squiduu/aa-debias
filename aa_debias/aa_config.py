...
def get_aa_args():
    ...
    parser.add_argument("--model_name", default="bert", type=str, choices=["bert", "roberta", "gpt2"])
    parser.add_argument("--seed", default=42, type=int)
    parser.add_argument("--batch_size", default=1, type=int)
    parser.add_argument("--debias_type", default="gender", type=str, choices=["gender", "race"])
    parser.add_argument("--run_no", default="run_00", type=str)
    parser.add_argument("--data_dir", default="./data/", type=str)
    parser.add_argument("--mode", default="prompt", type=str, choices=["prompt", "auto-debias", "aa-debias"])
    ...
    parser.add_argument("--save_dir", default="./debiased/", type=str)
